...
import { Search, Bell, Sun, Moon, Settings, LogOut, CheckCircle2, Database, X, Calendar, MessageSquare } from 'lucide-react'
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="relative" ref={panelRef}>
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 h-4 min-w-[16px] px-1 rounded-full bg-gradient-to-r from-rose to-pink-500 text-white text-[10px] flex items-center justify-center font-bold shadow-sm shadow-rose/40 animate-pulse-subtle">
                {unreadCount}
              </span>
            )}
          </button>
          {showNotifs && (
            <div className="absolute right-0 mt-2 w-[21rem] card-solid p-2 z-30 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-150">
        ...
        <div className="relative" ref={profileRef}>
          ...
          {showProfile && (
            <div className="absolute right-0 mt-2 w-[17rem] card-solid p-2 z-30 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-150">
