...
import { Search, Bell, Sun, Moon, CircleAlert, Settings, LogOut, Database, CheckCircle2 } from 'lucide-react'
          ...
          {showNotifs && (
            <div className="absolute right-0 mt-2 w-80 card p-2 z-30">
              ...
              <div className="max-h-80 overflow-y-auto scrollbar-thin divide-y divide-surface-lightborder dark:divide-surface-darkborder">
                ...
                {notifications.map((n) => (
                  <div key={n.id} className={classNames('px-2 py-2.5', !n.is_read && 'bg-signal/5')}>
            ...
            <div className="absolute right-0 mt-2 w-64 card p-2 z-30">
              <div className="flex items-center gap-3 px-2 py-2.5 border-b border-surface-lightborder dark:border-surface-darkborder mb-1.5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-black/45 dark:text-white/40 truncate">admin@orgsynq.ai</p>
                </div>
              </div>
              ...
              <button
                disabled
                title="Sign-in isn't enabled in this demo build"
                className="w-full flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm text-black/35 dark:text-white/30 cursor-not-allowed"
              >
