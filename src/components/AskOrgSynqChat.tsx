...
export default function AskOrgSynqChat() {
  ...
  async function handleSend(text?: string) {
    ...
    try {
      const reply = await askOrgSynq(msg, employees, geminiHistory)
      setMessages((prev) => [
        ...prev,
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-[11px] text-white/70">
              {isGeminiConfigured ? 'Gemini 1.5 Flash · Live' : 'Gemini not configured'}
            </p>
          </div>
        </div>
        <button
        ...
        <>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <div className="bg-black/[0.04] dark:bg-white/[0.06] rounded-2xl rounded-tl-sm p-3 text-sm max-w-[85%]">
                    Hi! I'm OrgSynq AI. I have live access to your workforce data.
              ...
              >
                ...
                <div
                  className={classNames(
                    'rounded-2xl px-3 py-2.5 text-sm max-w-[85%] whitespace-pre-wrap',
                    m.role === 'user'
          ...
          <div className="px-3 py-3 border-t border-surface-lightborder dark:border-surface-darkborder shrink-0">
            ...
            <p className="text-[10px] text-black/30 dark:text-white/25 mt-1.5 px-1">
              Powered by Gemini 1.5 Flash · {employees.length} employees in context
            </p>
          </div>
        </>
      )}
