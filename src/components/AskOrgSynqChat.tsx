...
export default function AskOrgSynqChat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col w-[380px] max-h-[580px] card-glass shadow-2xl overflow-hidden border border-slate-200/80 dark:border-white/[0.1] animate-in fade-in slide-in-from-bottom-3 duration-200">
      {/* Header */}
