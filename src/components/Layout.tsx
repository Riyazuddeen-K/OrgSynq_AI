...
import { Menu, X, Share2, LayoutDashboard, Users, Fingerprint, FlaskConical, BarChart3, Sparkles, Wand2, UserSquare2, GraduationCap, Briefcase, Trophy, FolderKanban, Settings, User, Calendar, MessageSquare, ShieldAlert } from 'lucide-react'
...
const ADMIN_MOBILE_NAV_ITEMS = [
  ...
  { to: '/internships', label: 'Internship Candidates', icon: GraduationCap },
  ...
  { to: '/audit-log', label: 'Admin Audit Log', icon: ShieldAlert },
              ...
              {mobileNavItems.map((item) => (
                ...
                >
                  ...
                  {item.to === '/chat' && unreadMessages > 0 && (
                    <span className="h-4 min-w-[16px] px-1 rounded-full bg-rose text-white text-[10px] font-bold flex items-center justify-center">
