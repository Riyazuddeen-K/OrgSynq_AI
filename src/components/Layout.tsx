...
import { Menu, X, Share2, LayoutDashboard, Users, Fingerprint, FlaskConical, BarChart3, Sparkles, Wand2, UserSquare2, Settings, User } from 'lucide-react'
...
const EMPLOYEE_ALLOWED_PATHS = ['/my-profile', '/settings']
