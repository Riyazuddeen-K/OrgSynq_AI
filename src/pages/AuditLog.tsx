...
export default function AuditLog() {
  ...
  const actionsTodayCount = useMemo(() => {
    ...
    return feed.filter((f) => new Date(f.created_at).getTime() >= startOfToday.getTime()).length
  }, [feed])
  ...
  return (
    <div>
      <Topbar
        ...
        subtitle="Enterprise compliance: chronological log of changes made by administrators"
      />
      ...
      <div className="p-4 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard icon={<ShieldAlert className="h-4 w-4 text-purple-500" />} value={actionsTodayCount} label="Actions Today" accent="signal" />
