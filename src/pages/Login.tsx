...
import { Mail, Lock, Eye, EyeOff, Zap, Shield, User as UserIcon, ArrowLeft } from 'lucide-react'
...
export default function Login() {
  ...
  // Already signed in (e.g. navigated here directly, or via back button) — go straight to the app
  ...
  return (
    <div className="min-h-screen bg-surface-lightbg dark:bg-surface-darkbg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        <Link
          to="/"
          className="inline-flex items-center gap-1.5 text-xs text-black/45 dark:text-white/40 hover:text-signal mb-6 focus-ring rounded"
        >
