        ...
        <div className="card p-5 h-fit lg:col-span-1 space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2.5 rounded-xl text-sm text-slate-900 dark:text-white bg-slate-50 dark:bg-surface-darkcard border border-slate-200 dark:border-white/[0.08] focus-ring"
            >
              <option>All</option>
              {departments.map((d) => (
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 pt-3 border-t border-slate-200 dark:border-white/[0.08]">
