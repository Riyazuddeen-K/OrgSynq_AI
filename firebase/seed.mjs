...
// service account file is needed — it just needs your Firestore rules
// to allow writes, which firestore.rules already does for this demo.
// =========================================================
...
async function main() {
  ...
  // -------------------------------------------------------
  const leads = [
    { id: 'oakley-robinson', name: 'Oakley Robinson', email: 'oakley.robinson@orgsynq.ai', title: 'HR Manager', department_id: 'hr', manager_id: 'casey-morgan', location: 'Chicago', status: 'Active', performance: 68, burnout: 78, attrition_risk: 38 },
    { id: 'noel-martinez', name: 'Noel Martinez', email: 'noel.martinez@orgsynq.ai', title: 'Head of Sales', department_id: 'sales', manager_id: 'casey-morgan', location: 'Austin', status: 'Active', performance: 75, burnout: 12, attrition_risk: 6 },
    { id: 'yael-wright', name: 'Yael Wright', email: 'yael.wright@orgsynq.ai', title: 'Head of Product', department_id: 'product', manager_id: 'taylor-reed', location: 'Seattle', status: 'Remote', performance: 66, burnout: 70, attrition_risk: 40 },
    { id: 'jamie-chen', name: 'Jamie Chen', email: 'jamie.chen@orgsynq.ai', title: 'Engineering Lead', department_id: 'engineering', manager_id: 'casey-morgan', location: 'San Francisco', status: 'Active', performance: 88, burnout: 41, attrition_risk: 15 },
    { id: 'faye-garcia', name: 'Faye Garcia', email: 'faye.garcia@orgsynq.ai', title: 'Design Lead', department_id: 'design', manager_id: 'taylor-reed', location: 'Denver', status: 'Remote', performance: 79, burnout: 33, attrition_risk: 22 },
    { id: 'cameron-wells', name: 'Cameron Wells', email: 'cameron.wells@orgsynq.ai', title: 'Finance Lead', department_id: 'finance', manager_id: 'taylor-reed', location: 'Boston', status: 'Active', performance: 81, burnout: 28, attrition_risk: 10 },
    { id: 'drew-adams', name: 'Drew Adams', email: 'drew.adams@orgsynq.ai', title: 'Marketing Lead', department_id: 'marketing', manager_id: 'casey-morgan', location: 'London', status: 'Active', performance: 74, burnout: 46, attrition_risk: 24 },
    { id: 'jade-patel', name: 'Jade Patel', email: 'jade.patel@orgsynq.ai', title: 'Operations Lead', department_id: 'operations', manager_id: 'taylor-reed', location: 'Austin', status: 'Remote', performance: 77, burnout: 39, attrition_risk: 19 }
  ]
